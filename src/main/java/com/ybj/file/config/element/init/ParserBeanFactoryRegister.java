...
import com.ybj.file.parse.regist.validator.datasource.DbEnumDataSourceFactory;
...
public class ParserBeanFactoryRegister
{
    ...
    static {
        ...
        ParserBeanFactoryRegister.regist(DbEnumDataSource.class, new DbEnumDataSourceFactory());
    }
